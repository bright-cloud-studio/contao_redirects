...
(
    ...
    (
        ...
        'enableVersioning'            => true,
		    ...
		    (
			    array('Bcs\Backend\Redirect', 'updatePublished')
		    ),
        'sql' => array
        (
            'keys' => array
    ...
    (
        ...
        (
            'fields' 				=> array('rule'),
            'format' 				=> '%s',
			'label_callback' 		=> array('Bcs\Backend\Redirect', 'generateLabel')
        ),
        ...
        (
			...
			(
				...
				'button_callback'     => array('Bcs\Backend\Redirect', 'toggleIcon')
			),
            'show' => array
            (
    ...
    (
		...
		'alias' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_redirect']['alias'],
			'exclude'                 => true,
			'inputType'               => 'text',
			'search'                  => true,
			...
			'save_callback' => array
			(
				array('Bcs\Backend\Redirect', 'generateAlias')
			),
		...
		'category' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_redirect']['category'],
            'search'                  => true,
			      'filter'				          => true,
            'inputType'               => 'text',
		...
		'code' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_redirect']['code'],
			      'filter'				          => true,
			      'inputType'               => 'select',
        ...
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_redirect']['redirect_domain'],
            'search'                  => true,
            'inputType'               => 'text',
		...
		'target_domain' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_redirect']['target_domain'],
            'search'                  => true,
            'inputType'               => 'text',
		...
		'target_page' => array
  		(
  			'label'                   => &$GLOBALS['TL_LANG']['tl_redirect']['target_page'],
  			'inputType'               => 'pageTree',
		...
		'target_file' => array
		(
        'label'                   => &$GLOBALS['TL_LANG']['tl_redirect']['target_file'],
        'inputType'               => 'fileTree',
		...
		'target_url' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_redirect']['target_url'],
            'search'                  => true,
            'inputType'               => 'text',
		...
		'domain' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_redirect']['domain'],
            'search'                  => true,
            'inputType'               => 'text',
            'eval'                    => array('maxlength'=>255, 'tl_class'=>'clr w50'),
            'sql'                     => "varchar(255) NOT NULL default ''"
